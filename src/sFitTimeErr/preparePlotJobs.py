...
variables = { 
#    'mass'    : ['total'],
#    'time'    : ['total','bkg','sig5.23', 'sig5.33','sig5.45','total','3body'],    
#    'eta'     : ['total','bkg','sig5.23', 'sig5.33','sig5.45','total','3body'],
...
fjobs = open(pathRUN+'/sFitTimeErr/jobsPlots.txt', 'a')
