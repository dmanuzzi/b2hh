config = {
    ...
    'blind'    : {
        ...
        # 'bskk_C_2018'      : 'B2hhLegacy_CKK',
        # 'bskk_S_2018'      : 'B2hhLegacy_SKK',
        # 'bskk_D_2018'      : 'B2hhLegacy_ADGKK',
...
from configuration2018 import config as config2018
from configuration2017s29r2p2 import config as config2017s29r2p2
from configuration2018alone import config as config2018alone
from configuration2017s29r2p2alone import config as config2017s29r2p2alone
from configuration2015161718 import config as config2015161718
...
def getConfigs(splitConf):
    ...
    tmpD_2018alone = mergeDictionaries(config, config2018alone)
    tmpD_2017s29r2p2alone = mergeDictionaries(config, config2017s29r2p2alone)
    tmpD_2015161718 = mergeDictionaries(config, config2015161718)
    if splitConf == '2015161718': 
        return tmpD_2015161718
    if splitConf == '201516': 
        return tmpD_201516
    elif splitConf == '2018': 
        return tmpD_2018alone
    elif splitConf == '2017s29r2p2':
        return tmpD_2017s29r2p2alone
    ...
    elif splitConf == '201516_2017s29r2p2_2018':
        tmpD_201516_2017s29r2p2 = mergeDictionaries(tmpD_201516, config2017s29r2p2)
        return mergeDictionaries(tmpD_201516_2017s29r2p2, config2018)
    elif splitConf == '2017':
