...
input_path = f"{b2hh_out}/Data/tuple_merged.bak/" #moved here as backup, may aswell read from them
output_path = f"{b2hh_out}/Data/tempFinalAssign/" #send to temporary directory prior to bit fix -> bit fix may as well cut on bdtPIPI at 0
