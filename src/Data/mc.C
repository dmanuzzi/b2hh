...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   readerPIPI->BookMVA( "BDT1", bdtWeights::bdtPIPI[fyear][0]);
   readerPIPI->BookMVA( "BDT2", bdtWeights::bdtPIPI[fyear][1]);
   readerPIPI->BookMVA( "BDT3", bdtWeights::bdtPIPI[fyear][2]);
   TMVA::Reader *readerKK = new TMVA::Reader(varNames, "!Color:!Silent", true);
   readerKK->BookMVA("BDT1", bdtWeights::bdtKK[fyear][0]);
   readerKK->BookMVA("BDT2", bdtWeights::bdtKK[fyear][1]);
   readerKK->BookMVA("BDT3", bdtWeights::bdtKK[fyear][2]);
   TMVA::Reader *readerGPIPI = new TMVA::Reader(varNames, "!Color:!Silent", true);
   readerGPIPI->BookMVA("BDT1", bdtWeights::bdtgPIPI[fyear][0]);
   readerGPIPI->BookMVA("BDT2", bdtWeights::bdtgPIPI[fyear][1]);
   readerGPIPI->BookMVA("BDT3", bdtWeights::bdtgPIPI[fyear][2]);
   TMVA::Reader *readerGKK = new TMVA::Reader(varNames, "!Color:!Silent", true);
   readerGKK->BookMVA("BDT1", bdtWeights::bdtgKK[fyear][0]);
   readerGKK->BookMVA("BDT2", bdtWeights::bdtgKK[fyear][1]);
   readerGKK->BookMVA("BDT3", bdtWeights::bdtgKK[fyear][2]);
   ...
   Int_t qOScharm = 0, qOSele = 0, qOSk = 0, qOSmu = 0, qOSvtx = 0, qOS = 0,
         qSSpi = 0, qSSp = 0, qSSk = 0, qSS = 0, qTrue = 0,
   ...
   if(fdecay=="bdkk")   { plusID = 321;  minusID = -321;  bID = 511;  }
   if(fdecay=="bskk")   { plusID = 321;  minusID = -321;  bID = 531;  }
   if(fdecay=="bskpi")  { plusID = 321;  minusID = -211;  bID = 531;  }
   if(fdecay=="bspik")  { plusID = 211;  minusID = -321;  bID = 531;  }
   if(fdecay=="bspipi") { plusID = 211;  minusID = -211;  bID = 531;  }
   if(fdecay=="lbpk")   { plusID = 2212; minusID = -321;  bID = 5122; }
   if(fdecay=="lbkp")   { plusID = 321;  minusID = -2212; bID = 5122; }
   if(fdecay=="lbppi")  { plusID = 2212; minusID = -211;  bID = 5122; }
   if(fdecay=="lbpip")  { plusID = 211;  minusID = -2212; bID = 5122; }

   TTree * outTree = new TTree("b2hh","b2hh");
   // RTA WP4
   Double_t B0_0_K_0_P       = 0, B0_0_K_0_PT       = 0,
            B0_0_K_0_PIDe    = 0, B0_0_K_0_PIDmu    = 0,
            B0_0_K_0_PIDK    = 0, B0_0_K_0_PIDp     = 0,
            B0_0_K_0_ProbNNe = 0, B0_0_K_0_ProbNNmu = 0,
            B0_0_K_0_ProbNNk = 0, B0_0_K_0_ProbNNpi = 0, B0_0_K_0_ProbNNp = 0,
            B0_0_pi_0_P       = 0, B0_0_pi_0_PT       = 0,
            B0_0_pi_0_PIDe    = 0, B0_0_pi_0_PIDmu    = 0,
            B0_0_pi_0_PIDK    = 0, B0_0_pi_0_PIDp     = 0,
   ...
   outTree->Branch("B0_0_K_0_PIDmu",&B0_0_K_0_PIDmu,"B0_0_K_0_PIDmu/D");
   outTree->Branch("B0_0_K_0_PIDK",&B0_0_K_0_PIDK,"B0_0_K_0_PIDK/D");
   outTree->Branch("B0_0_K_0_PIDp",&B0_0_K_0_PIDp,"B0_0_K_0_PIDp/D");
   outTree->Branch("B0_0_K_0_ProbNNe",&B0_0_K_0_ProbNNe,"B0_0_K_0_ProbNNe/D");
   outTree->Branch("B0_0_K_0_ProbNNmu",&B0_0_K_0_ProbNNmu,"B0_0_K_0_ProbNNmu/D");
   outTree->Branch("B0_0_K_0_ProbNNk",&B0_0_K_0_ProbNNk,"B0_0_K_0_ProbNNk/D");
   outTree->Branch("B0_0_K_0_ProbNNpi",&B0_0_K_0_ProbNNpi,"B0_0_K_0_ProbNNpi/D");
   outTree->Branch("B0_0_K_0_ProbNNp",&B0_0_K_0_ProbNNp,"B0_0_K_0_ProbNNp/D");
   outTree->Branch("B0_0_K_0_TRUEID",&B0_0_K_0_TRUEID,"B0_0_K_0_TRUEID/I");

   outTree->Branch("B0_0_pi_0_P",&B0_0_pi_0_P,"B0_0_pi_0_P/D");
   outTree->Branch("B0_0_pi_0_PT",&B0_0_pi_0_PT,"B0_0_pi_0_PT/D");
   outTree->Branch("B0_0_pi_0_PIDe",&B0_0_pi_0_PIDe,"B0_0_pi_0_PIDe/D");
   outTree->Branch("B0_0_pi_0_PIDmu",&B0_0_pi_0_PIDmu,"B0_0_pi_0_PIDmu/D");
   outTree->Branch("B0_0_pi_0_PIDK",&B0_0_pi_0_PIDK,"B0_0_pi_0_PIDK/D");
   outTree->Branch("B0_0_pi_0_PIDp",&B0_0_pi_0_PIDp,"B0_0_pi_0_PIDp/D");
   outTree->Branch("B0_0_pi_0_ProbNNe",&B0_0_pi_0_ProbNNe,"B0_0_pi_0_ProbNNe/D");
   outTree->Branch("B0_0_pi_0_ProbNNmu",&B0_0_pi_0_ProbNNmu,"B0_0_pi_0_ProbNNmu/D");
   outTree->Branch("B0_0_pi_0_ProbNNk",&B0_0_pi_0_ProbNNk,"B0_0_pi_0_ProbNNk/D");
   ...
   outTree->Branch("truePPlus", &truePPlus, "truePPlus/D" );
   outTree->Branch("truePMinus",&truePMinus,"truePMinus/D");
   outTree->Branch("truePP",    &truePP,    "truePP/D"    );
   outTree->Branch("trueBPX",   &trueBPX,   "trueBPX/D"   );
   outTree->Branch("trueBPY",   &trueBPY,   "trueBPY/D"   );
   outTree->Branch("trueBPZ",   &trueBPZ,   "trueBPZ/D"   );
   // Decay times and Decay time errors
   ...
   outTree->Branch("fromBc",&fromBc,"fromBc/I");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      fromBc        = abs(B0_MC_MOTHER_ID) == 541 ||
                      abs(B0_MC_GD_MOTHER_ID) == 541 ||
                      abs(B0_MC_GD_GD_MOTHER_ID) == 541;
      if(!mcassociation) continue;
      ...
      else if(myRand>=1 && myRand < 2) idBDT = 2;
      else if(myRand>=2 && myRand < 3) idBDT = 3;


      if(piplus_TRUEID==321) {
        B0_0_K_0_TRUEID    = piplus_TRUEID;   B0_0_pi_0_TRUEID    = piminus_TRUEID;
        B0_0_K_0_P         = piplus_P;        B0_0_K_0_PT         = piplus_PT;
        B0_0_K_0_PIDe      = piplus_PIDe;     B0_0_K_0_PIDmu      = piplus_PIDmu;
        B0_0_K_0_PIDK      = piplus_PIDK;     B0_0_K_0_PIDp       = piplus_PIDp;
        B0_0_K_0_ProbNNe   = piplus_ProbNNe;  B0_0_K_0_ProbNNmu   = piplus_ProbNNmu;
        B0_0_K_0_ProbNNk   = piplus_ProbNNk;  B0_0_K_0_ProbNNpi   = piplus_ProbNNpi; 
        B0_0_K_0_ProbNNp   = piplus_ProbNNp;
        B0_0_pi_0_P        = piminus_P;       B0_0_pi_0_PT        = piminus_PT;
        B0_0_pi_0_PIDe     = piminus_PIDe;    B0_0_pi_0_PIDmu     = piminus_PIDmu;
        B0_0_pi_0_PIDK     = piminus_PIDK;    B0_0_pi_0_PIDp      = piminus_PIDp;
        B0_0_pi_0_ProbNNe  = piminus_ProbNNe; B0_0_pi_0_ProbNNmu  = piminus_ProbNNmu;
        B0_0_pi_0_ProbNNk  = piminus_ProbNNk; B0_0_pi_0_ProbNNpi  = piminus_ProbNNpi; 
      }
      else {
        B0_0_pi_0_TRUEID  = piplus_TRUEID;   B0_0_K_0_TRUEID    = piminus_TRUEID;
        B0_0_pi_0_P       = piplus_P;        B0_0_pi_0_PT       = piplus_PT;
        B0_0_pi_0_PIDe    = piplus_PIDe;     B0_0_pi_0_PIDmu    = piplus_PIDmu;
        B0_0_pi_0_PIDK    = piplus_PIDK;     B0_0_pi_0_PIDp     = piplus_PIDp;
        B0_0_pi_0_ProbNNe = piplus_ProbNNe;  B0_0_pi_0_ProbNNmu = piplus_ProbNNmu;
        B0_0_pi_0_ProbNNk = piplus_ProbNNk;  B0_0_pi_0_ProbNNpi = piplus_ProbNNpi;
        B0_0_pi_0_ProbNNp = piplus_ProbNNp;
        B0_0_K_0_P        = piminus_P;       B0_0_K_0_PT        = piminus_PT;
        B0_0_K_0_PIDe     = piminus_PIDe;    B0_0_K_0_PIDmu     = piminus_PIDmu;
        B0_0_K_0_PIDK     = piminus_PIDK;    B0_0_K_0_PIDp      = piminus_PIDp;
        B0_0_K_0_ProbNNe  = piminus_ProbNNe; B0_0_K_0_ProbNNmu  = piminus_ProbNNmu;
      ...
      truePPlus      = piplus_TRUEP_X*piplus_TRUEP_X+piplus_TRUEP_Y*piplus_TRUEP_Y+piplus_TRUEP_Z*piplus_TRUEP_Z;
      truePMinus     = piminus_TRUEP_X*piminus_TRUEP_X+piminus_TRUEP_Y*piminus_TRUEP_Y+piminus_TRUEP_Z*piminus_TRUEP_Z;
      truePP         = piplus_TRUEP_X*piminus_TRUEP_X+piplus_TRUEP_Y*piminus_TRUEP_Y+piplus_TRUEP_Z*piminus_TRUEP_Z;
      trueBPX        = B0_TRUEP_X;
      trueBPY        = B0_TRUEP_Y;
      trueBPZ        = B0_TRUEP_Z;
      // Decay times and Decay time errors
      ...
      qTrue    = piplus_MC_MOTHER_ID/abs(piplus_MC_MOTHER_ID);
      ...
      BDT1_PIPI = readerPIPI->EvaluateMVA(vars,"BDT1");
      BDT2_PIPI = readerPIPI->EvaluateMVA(vars,"BDT2");
      BDT3_PIPI = readerPIPI->EvaluateMVA(vars,"BDT3");
      BDT1_KK   = readerKK->EvaluateMVA(vars,"BDT1");
      BDT2_KK   = readerKK->EvaluateMVA(vars,"BDT2");
      BDT3_KK   = readerKK->EvaluateMVA(vars,"BDT3");
   ...
   TFile * outFile = new TFile(Form("$B2HH_OUT/Data/tuple/%s_%s_%s_%d.root",fdecay.Data(),fyear.Data(),fmagnet.Data(),findex),"RECREATE","",6);
