...
//by  b_branchname->GetEntry(ientry); //read only this branch
  ...
  //  varNames.push_back("bPT");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      BDTG2_PIPI = readerGPIPI->EvaluateMVA(vars, bdtWeights::bdtgPIPI[fyear][1].first);
      BDTG3_PIPI = readerGPIPI->EvaluateMVA(vars, bdtWeights::bdtgPIPI[fyear][2].first);
      BDTG1_KK   = readerGKK->  EvaluateMVA(vars, bdtWeights::bdtgKK  [fyear][0].first);
      BDTG2_KK   = readerGKK->  EvaluateMVA(vars, bdtWeights::bdtgKK  [fyear][1].first);
      BDTG3_KK   = readerGKK->  EvaluateMVA(vars, bdtWeights::bdtgKK  [fyear][2].first);
