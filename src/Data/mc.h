...
// Mon May 28 13:43:17 2018 by ROOT version 6.06/02
// from TTree PreSelB2HH/PreSelB2HH
// found on file: /storage/gpfs_data/local/lhcb/users/perazzini/gangadir/workspace/perazzini/LocalXML/201/7/output/b2hh.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   mc(TTree *tree=0, TString decay="b2hh", TString year="2015", TString magnet="Up", Int_t index=1);
   virtual ~mc();
...
#ifdef mc_cxx
mc::mc(TTree *tree, TString decay, TString year, TString magnet, Int_t index) : fChain(0) 
{
...
void mc::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("B0_OSCharm_TAGDEC", &B0_OSCharm_TAGDEC, &b_B0_OSCharm_TAGDEC);
   fChain->SetBranchAddress("B0_OSCharm_TAGETA", &B0_OSCharm_TAGETA, &b_B0_OSCharm_TAGETA);
   fChain->SetBranchAddress("B0_OSCharm_CHARGE", &B0_OSCharm_CHARGE, &b_B0_OSCharm_CHARGE);
   fChain->SetBranchAddress("B0_OSCharm_MVAOUT", &B0_OSCharm_MVAOUT, &b_B0_OSCharm_MVAOUT);
   fChain->SetBranchAddress("B0_OSElectron_TAGDEC", &B0_OSElectron_TAGDEC, &b_B0_OSElectron_TAGDEC);
   fChain->SetBranchAddress("B0_OSElectron_TAGETA", &B0_OSElectron_TAGETA, &b_B0_OSElectron_TAGETA);
   fChain->SetBranchAddress("B0_OSElectron_CHARGE", &B0_OSElectron_CHARGE, &b_B0_OSElectron_CHARGE);
   fChain->SetBranchAddress("B0_OSElectron_MVAOUT", &B0_OSElectron_MVAOUT, &b_B0_OSElectron_MVAOUT);
   ...
   fChain->SetBranchAddress("B0_OSKaon_TAGDEC", &B0_OSKaon_TAGDEC, &b_B0_OSKaon_TAGDEC);
   fChain->SetBranchAddress("B0_OSKaon_TAGETA", &B0_OSKaon_TAGETA, &b_B0_OSKaon_TAGETA);
   fChain->SetBranchAddress("B0_OSKaon_CHARGE", &B0_OSKaon_CHARGE, &b_B0_OSKaon_CHARGE);
   fChain->SetBranchAddress("B0_OSKaon_MVAOUT", &B0_OSKaon_MVAOUT, &b_B0_OSKaon_MVAOUT);
   ...
   fChain->SetBranchAddress("B0_OSMuon_TAGDEC", &B0_OSMuon_TAGDEC, &b_B0_OSMuon_TAGDEC);
   fChain->SetBranchAddress("B0_OSMuon_TAGETA", &B0_OSMuon_TAGETA, &b_B0_OSMuon_TAGETA);
   fChain->SetBranchAddress("B0_OSMuon_CHARGE", &B0_OSMuon_CHARGE, &b_B0_OSMuon_CHARGE);
   fChain->SetBranchAddress("B0_OSMuon_MVAOUT", &B0_OSMuon_MVAOUT, &b_B0_OSMuon_MVAOUT);
   ...
   fChain->SetBranchAddress("B0_OSVtxCh_TAGDEC", &B0_OSVtxCh_TAGDEC, &b_B0_OSVtxCh_TAGDEC);
   fChain->SetBranchAddress("B0_OSVtxCh_TAGETA", &B0_OSVtxCh_TAGETA, &b_B0_OSVtxCh_TAGETA);
   fChain->SetBranchAddress("B0_OSVtxCh_CHARGE", &B0_OSVtxCh_CHARGE, &b_B0_OSVtxCh_CHARGE);
   fChain->SetBranchAddress("B0_OSVtxCh_MVAOUT", &B0_OSVtxCh_MVAOUT, &b_B0_OSVtxCh_MVAOUT);
   fChain->SetBranchAddress("B0_SSKaon_TAGDEC", &B0_SSKaon_TAGDEC, &b_B0_SSKaon_TAGDEC);
   fChain->SetBranchAddress("B0_SSKaon_TAGETA", &B0_SSKaon_TAGETA, &b_B0_SSKaon_TAGETA);
   fChain->SetBranchAddress("B0_SSKaon_CHARGE", &B0_SSKaon_CHARGE, &b_B0_SSKaon_CHARGE);
   fChain->SetBranchAddress("B0_SSKaon_MVAOUT", &B0_SSKaon_MVAOUT, &b_B0_SSKaon_MVAOUT);
   ...
   fChain->SetBranchAddress("B0_SSPion_TAGDEC", &B0_SSPion_TAGDEC, &b_B0_SSPion_TAGDEC);
   fChain->SetBranchAddress("B0_SSPion_TAGETA", &B0_SSPion_TAGETA, &b_B0_SSPion_TAGETA);
   fChain->SetBranchAddress("B0_SSPion_CHARGE", &B0_SSPion_CHARGE, &b_B0_SSPion_CHARGE);
   fChain->SetBranchAddress("B0_SSPion_MVAOUT", &B0_SSPion_MVAOUT, &b_B0_SSPion_MVAOUT);
   fChain->SetBranchAddress("B0_SSProton_TAGDEC", &B0_SSProton_TAGDEC, &b_B0_SSProton_TAGDEC);
