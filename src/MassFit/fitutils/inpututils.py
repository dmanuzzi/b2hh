...
inputs['outParams']['path']     = outPath+'/MassFit/{outdir}/'
...
inputs['fitParams']['file']     = inputs['fitParams']['path']    +'input_params_massFit_{bdtName}_{bdtCut}_{taggers}_{magnet}.txt.{blindState}'
