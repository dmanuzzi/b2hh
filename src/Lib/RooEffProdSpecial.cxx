...
/////////////////////////////////////////////////////////////////////////////////////
// BEGIN_HTML
// The class RooEffProdSpecial implements the product of a PDF with an efficiency function.
...
#ifndef ROO_EFF_PROD_SPECIAL_cxx
#define ROO_EFF_PROD_SPECIAL_cxx
...
RooEffProdSpecial::RooEffProdSpecial(const char *name, const char *title, 
...
RooEffProdSpecial::RooEffProdSpecial(const RooEffProdSpecial& other, const char* name) : 
...
RooEffProdSpecial::~RooEffProdSpecial() 
{
}
...
/*
Double_t RooEffProdSpecial::getValV(const RooArgSet* set) const 
{  
  _nset = _fixedNset ? _fixedNset : set ;
  return RooAbsPdf::getValV(set) ;
}
*/
Double_t RooEffProdSpecial::getValV(const RooArgSet* nset) const {
  if (!nset) {
...
Double_t RooEffProdSpecial::evaluate() const
{
...
////////////////////////////////////////////////////////////////////////////////
/// Return specialized generator context for RooEffProdSpecials that implements generation
/// in a more efficient way than can be done for generic correlated products

RooAbsGenContext* RooEffProdSpecial::genContext(const RooArgSet &vars, const RooDataSet *prototype,
...
///
/// This implementation in RooEffProdSpecial catches all integrals without normalization and reroutes them
...
Int_t RooEffProdSpecial::getAnalyticalIntegralWN(RooArgSet& allVars, RooArgSet& analVars, 
					  const RooArgSet* normSet, const char* rangeName) const 
{
  ...
  // integrals over a RooEffProdSpecial without normalization setup are explicitly handled here. These integrals
  // are calculated using a clone of the RooEffProdSpecial that has a fixed normalization set passed to the
  ...
  cache->_clone = (RooEffProdSpecial*) clone(Form("%s_clone",GetName())) ;
...
Double_t RooEffProdSpecial::analyticalIntegralWN(Int_t code, const RooArgSet* normSet, const char* /*rangeName*/) const 
{
...
RooArgList RooEffProdSpecial::CacheElem::containedArgs(Action) 
{
