Int_t plotMaps(TString hypo, TString cuts, TString binning, TString magnet, TString year){
  ...
  TFile * inFile = new TFile("${B2HH_OUT}/PID/effCalib/TrackEff/eff"+hypo+"_"+cuts+"_"+binning+"_"+magnet+"_"+year+".root","READ");
  ...
  hEffKplus->GetZaxis()->SetRangeUser(0,hEffKplus->GetMaximum()*0+1);
  ...
  hEffKminus->GetZaxis()->SetRangeUser(0,hEffKminus->GetMaximum()*0+1);
  ...
  hEffPIplus->GetZaxis()->SetRangeUser(0,hEffPIplus->GetMaximum()*0+1);
  ...
  hEffPIminus->GetZaxis()->SetRangeUser(0,hEffPIminus->GetMaximum()*0+1);
  ...
  hEffPplus->GetZaxis()->SetRangeUser(0,hEffPplus->GetMaximum()*0+1);
  ...
  hEffPminus->GetZaxis()->SetRangeUser(0,hEffPminus->GetMaximum()*0+1);
  ...
  for (auto canv : {cKplus, cKminus, cPIplus, cPIminus, cPplus, cPminus}){
    TString nfout = "${B2HH_OUT}/PID/effB2HH/plots/effMap_"+hypo+"_"+cuts+"_"+binning+"_"+magnet+"_"+year+"__"+TString(canv->GetName());
    canv->SaveAs(nfout+".pdf");
    canv->SaveAs(nfout+".png");
    canv->SaveAs(nfout+".root");
  }
