...
int averageSigmaT(){
  ...
  if (year == "2015" || year == "2016" || year == "201516"){
    ...
    nfins = {"$B2HH_OUT/Reduce/b2hh_KK_0.1_201516_Tot.root/b2hh"};
    ...
    nfins = {"$B2HH_OUT/Reduce/b2hh_KK_0.1_2017s29r2p2_Tot.root/b2hh"};
    ...
    nfins = {"$B2HH_OUT/Reduce/b2hh_KK_0.1_2018_Tot.root/b2hh"};
  } else return 0;
