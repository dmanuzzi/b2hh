...
if [[ $5 == "PIPI" ]]; then
    ${lbRunDaVinciOld} ${B2HH_SRC}/Tagging/pidWeights    -d $1 -b $2 -y $3 -m $4 -f PIPI -c "${6}"
    ...
    ${lbRunDaVinciOld} ${B2HH_SRC}/Tagging/createBKG     -C $1 -b $2 -y $3 -m $4 -f pipi -c "${6}"
elif [[ $5 == "KK" ]]; then
    ${lbRunDaVinciOld} ${B2HH_SRC}/Tagging/pidWeights    -d $1 -b $2 -y $3 -m $4 -f KK -c "${7}"
    ...
    ${lbRunDaVinciOld} ${B2HH_SRC}/Tagging/createBKG     -C $1 -b $2 -y $3 -m $4 -f kk -c "${7}"
elif [[ $5 == "KPI" ]]; then 
    ${lbRunDaVinciOld} ${B2HH_SRC}/Tagging/pidWeights    -d $1 -b $2 -y $3 -m $4 -f KPI -c "${8}"
    ...
    ${lbRunDaVinciOld} ${B2HH_SRC}/Tagging/createBKG     -C $1 -b $2 -y $3 -m $4 -f kpi -c "${8}"
else
