...
#years="Tot__201516__2017s29r2p2__2018"
...
kpi_pid="5.-2.-5.3"
pik_pid="-5.3.5.-2"
#pipi_pid="-2.3.-2.3" #baseline bdpipi cut
pipi_pid="-1.3.-1.3"
kk_pid="2.-2.2.-2"
cuts_pid="kpi_${kpi_pid}__pik_${pik_pid}__pipi_${pipi_pid}__kk_${kk_pid}"

#cuts_pid="kpi_5.-2.-5.3__pik_-5.3.5.-2__pipi_-1.3.-1.3__kk_2.-2.2.-2"

#cuts_bdt="KK_0.1__PIPI_0.2"

#cuts_bdt="PIPI_0" #looser requirement for sPlot in bspipi Selection
...
#toys="101"
opts=''
#opts+="__noCPVbspipi" #for bspipi selection toys
...
#${B2HH_RUN}/Reduce/runAll.sh ${years} ${magnets} ${cuts_bdt} ${kpi_pid} ${pik_pid} ${pipi_pid} ${kk_pid}
...
#${B2HH_RUN}/Tagging/runAll.sh  ${years} ${magnets} ${cuts_bdt} ${pipi_pid} ${kk_pid} ${kpi_pid}
