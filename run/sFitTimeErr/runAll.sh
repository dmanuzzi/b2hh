...
mkdir -p ${B2HH_LOG}/sFitTimeErr/out
mkdir -p ${B2HH_LOG}/sFitTimeErr/err
mkdir -p ${B2HH_LOG}/sFitTimeErr/log

mkdir -p ${B2HH_OUT}/sFitTimeErr
...
for cut_bdt in ${cuts_bdt}; do  
    for year in ${years}; do 
        for mag in ${magnets}; do
            ...
            mkdir -p ${B2HH_OUT}/sFitTimeErr/${outDir}
